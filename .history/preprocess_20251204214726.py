...
def _read_raw(path: str) -> pd.DataFrame:
    ...
    if not os.path.exists(path):
        raise FileNotFoundError(
            ...
            f"Please either:\n"
            f"1. Set DATA_CSV environment variable: set DATA_CSV=path\\to\\your\\scada.xlsx\n"
            f"2. Create data/ folder and place scada.xlsx there\n"
            f"3. Edit DATA_CSV in config.py with your file path"
        )
